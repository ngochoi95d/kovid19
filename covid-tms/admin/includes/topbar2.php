          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                ?>
                    <a class="dropdown-item d-flex align-items-center" href="test-details.php?tid=<?php echo $row['id']; ?>&&oid=<?php echo $row['OrderNumber']; ?>">
                      ...
                      <div>
                        ...
                        <span class="font-weight-bold">Yêu cầu mới nhận # <?php echo $row['OrderNumber']; ?></span>
                      </div>
                    </a>
                  <?php }
                } else { ?>
                ...
                <a class="dropdown-item text-center small text-gray-500" href="new-test.php">Hiển thị tất cả thông báo</a>
              </div>
            </li>
