...
?>
    ...
    <head>
        ...
        <title>Kovid 19 | Kết quả tìm kiếm báo cáo theo ngày</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Kết quả tìm kiếm báo cáo theo ngày <?php echo $fdate; ?> to <?php echo $tdate; ?> </h1>


                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Kết quả tìm kiếm báo cáo theo ngày</h6>
                            </div>
                            <div class="card-body">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="test-details.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>" class="btn btn-info btn-sm" target="blank">Thông tin chi tiết</a>
