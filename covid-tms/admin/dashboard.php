                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Quản lý quy trình lấy mẫu</h1>
                            <a href="bwdates-report-ds.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Kết quả báo cáo</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            //Assigned tests
                            $query1 = mysqli_query($con, "select id from tbltestrecord where ReportStatus='Chỉ định'");
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <a href="ontheway-samplecollection-test.php">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> Trên đường lấy mẫu
                                                    </div>
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-auto">
                                    ...
                                    <a href="samplesent-lab-test.php">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                        Mẫu được gửi đến phòng thí nghiệm</div>
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <a href="reportdelivered-test.php">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Báo cáo kết quả được phân phối
                                                    </div>
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-auto">
                                    ...
                                    <a href="manage-phlebotomist.php">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                        Số kỹ thuật viên xét nghiệm đã đăng ký</div>
