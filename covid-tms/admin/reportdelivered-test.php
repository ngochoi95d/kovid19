...
?>
    ...
    <head>
        ...
        <title>Covid-Tms | Tổng hợp kết quả báo cáo đã xét nghiệm</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Tổng hợp kết quả báo cáo đã xét nghiệm</h1>


                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tổng hợp kết quả báo cáo đã xét nghiệm</h6>
                            </div>
                            <div class="card-body">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="test-details.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>" class="btn btn-info btn-sm">Thông tin chi tiết</a>
